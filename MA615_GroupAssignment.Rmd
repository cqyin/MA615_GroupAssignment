...
From the American map based the number of fraud cases, we can see that Texas state, California state and New York have more fraud cases in 2017 than any other states. It is an intuitionistic and vivid visualization to show the results.

Then, from the boxplot, we can compare the numbers of fraud cases from 2012 to 2018 easily. From 2012 to 2017, the total number of fraud cases has a obvious trend of increasing. 

At last, the count of frauds reported increased largely through the last few years. Since the data of 2018 has not been complete yet, we may still predict a trend of growth. California and New York were typically among the top five States that most frauds were reported. Massachusetts ranked first in 2013 and 2014, but ended with fifth in 2015, 2016 and 2017.
